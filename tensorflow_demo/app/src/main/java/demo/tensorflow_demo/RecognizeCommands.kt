...
class RecognizeCommands(
    ...
    fun processLatestResults(currentResults: FloatArray, currentTimeMS: Long): RecognitionResult {
        ...
        val howManyResults = previousResults.size
        ...
        if (previousTopLabel == SILENCE_LABEL || previousTopLabelTime == java.lang.Long.MIN_VALUE) {
